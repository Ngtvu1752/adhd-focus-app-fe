...
const SignInForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white flex flex-col px-12 h-full justify-center items-center">
      <h1 className="font-bold text-text-primary text-[32px]">Đăng Nhập</h1>
      
      <div className="my-5">
        {/* Cập nhật hover/shadow theo màu --color-accent */}
        <a href="#" className="border border-gray-300 rounded-full inline-flex justify-center items-center mx-2 h-11 w-11 transition-all duration-300 ease-in-out hover:border-accent hover:-translate-y-1 hover:shadow-[0_5px_15px_rgba(255,217,102,0.3)]">
      ...
      <span className="text-[13px] text-text-primary/60">hoặc sử dụng tài khoản</span>
      ...
      <button 
        type="submit"
        disabled={loading}
        className="rounded-[25px] border-none bg-login-accent from-overlay-start to-overlay-end text-white text-sm font-semibold py-3.5 px-12 tracking-wider uppercase transition-all duration-300 cursor-pointer mt-5 shadow-[0_5px_15px_rgba(74,144,226,0.4)] hover:-translate-y-1 hover:shadow-[0_8px_25px_rgba(74,144,226,0.6)] active:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
      >
